...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://klmyanagit checkout -b develop.github.io/react_sum/) and add it to the PR description.
