...
**Зверніть увагу:** використовуйте іменований експорт (не за замовчуванням).

`App` має містити такі компоненти `Sum`:

- `a = 2` та `b = 3`;
- `a = -5` та `b = 5`;
- лише `a = 10`;
- лише `b = 5`;
- взагалі без параметрів.
...
- Replace ElinaMrachkovska with your Github username in the [DEMO LINK](https://ElinaMrachkovska.github.io/react_sum/) and add it to the PR description.
