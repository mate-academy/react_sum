git switch -c develop# Sum Component
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Korochenko.github.io/react_sum/) and add it to the PR description.
