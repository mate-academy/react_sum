...
- Open one more terminal and run tests with `npm test` to ensure your solution is correct.v 
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Mykola-Maik.github.io/react_sum/) and add it to the PR description.
